...
export type ReloadTabListenersMessage = MessageWithValue<typeof MESSAGE_TYPE_RELOAD_TAB_LISTENERS, boolean>

export const MESSAGE_TYPE_UPDATE_LOG_LEVEL = 'update_log_level'
export type UpdateLogLevelMessage = MessageWithValue<typeof MESSAGE_TYPE_UPDATE_LOG_LEVEL, boolean>

export const MESSAGE_TYPE_UPDATE_SESSIONS_LIST = 'update_sessions'
export type UpdateSessionsListMessage = MessageWithValue<typeof MESSAGE_TYPE_UPDATE_SESSIONS_LIST, SessionLists>

export const MESSAGE_TYPE_GET_SESSIONS_LIST = 'get_sessions'
export type GetSessionsListMessage = Message<typeof MESSAGE_TYPE_GET_SESSIONS_LIST>
