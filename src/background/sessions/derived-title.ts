...
const getTitlesFromTabs = (tabs: browser.tabs.Tab[]) => {
...
export const getWindowTitle = (tabs: browser.tabs.Tab[]) => {
  const titles = getTitlesFromTabs(tabs)
  return formatTopTitlesAndMore(titles)
}

export const getSessionTitle = (windows: browser.windows.Window[]) => {
